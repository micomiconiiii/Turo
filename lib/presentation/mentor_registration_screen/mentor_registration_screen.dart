  ...
  import '../../models/user_detail_model.dart' as user_detail_model;
  ...
  class _MentorRegistrationScreenState extends State<MentorRegistrationScreen> {
    ...
    void _onNextPressed(BuildContext context) {
      if (_formKey.currentState?.validate() == true) {
        ...
        // Build user data and navigate to next screen without saving yet
        ...
        final DateTime birthdateDate = DateTime(year, month, day);

        final String address =
            '${_addressUnitBldgController.text}, ${_addressStreetController.text}, ${_addressBarangayController.text}, ${_cityController.text}, ${_provinceController.text}, ${_zipCodeController.text}';
        ...
        final userDetail = user_detail_model.UserDetailModel(
          userId: widget.uid,
          email: email,
